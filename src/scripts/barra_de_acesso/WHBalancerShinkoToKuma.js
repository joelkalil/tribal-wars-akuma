...
//Akuma visual modification by Akuma. Version: v2026.05.10-akuma.1
...
<style>
    ...
    #akuma-wh-loading {
        background: linear-gradient(90deg, rgba(34, 255, 122, 0.12), rgba(53, 167, 255, 0.08)), var(--akuma-panel) !important;
        padding: 16px 18px !important;
    }

    #akuma-wh-loading strong {
    ...
    .collapsible {
        ...
        color: var(--akuma-green) !important;
        border-bottom: 1px solid var(--akuma-border) !important;
    }
    ...
    .sophRowA:hover,
    .sophRowB:hover {
        background: rgba(53, 167, 255, 0.10) !important;
    }
    ...
    #settings input[type="range"] {
        accent-color: var(--akuma-green) !important;
    }
...
$("#content_value").eq(0).prepend(`
    <div id="akuma-wh-loading">
        <strong>Warehouse Balancer</strong>
        <span>Carregando dados de mercado e producao...</span>
    </div>
`);
