            ...
            if (coordinatesFillMode === 'manual') {
                ...
                if (coordinatesArray.length) {
                    ...
                    const scriptNew = `javascript:var config=${JSON.stringify(
                        config
                    )};$.ajax({type: 'GET',url: 'https://raw.githubusercontent.com/joelkalil/tribal-wars-akuma/refs/heads/main/src/scripts/barra_de_acesso/fakeScriptClient.js',dataType: 'script',cache: true});`;
