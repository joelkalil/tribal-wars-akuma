/*
 * Script Name: Farm Efficiency Calculator
 * Version: v2.0.4-akuma.1
...
var scriptConfig = {
    ...
    translations: {
        ...
        hu_HU: {
            'Farm Efficiency Calculator': 'Farm hatékonysági kalkulátor',
            Help: 'Segítség',
            'Redirecting...': 'Átirányítás...',
            'There was an error!': 'Hiba lépett fel!',
            'There was an error while fetching the report data!':
                'Hiba lépett fel az adatok kiolvasása közbe a jelentésekből!',
            'Farmed Villages': 'Farmolt faluk',
            'Total Looted': 'Össz. farmolás',
            'Total Estimated': 'Össz. becsült farmolás',
            'Total Wood Hauled': 'Össz. farmolt fa',
            'Total Clay Hauled': 'Össz. farmolt agyag',
            'Total Iron Hauled': 'Össz. farmolt vas',
            'Total LC Used': 'Össz. KL használatban',
            'Farming Efficiency': 'Farm hatékonysági ráta',
            'Average Loot': 'Farm átlag',
            'Average Estimated Loot': 'Farm becsült átlag',
            'Average Hauled Wood': 'Farmolt fa átlag',
            'Average Hauled Clay': 'Farmolt agyag átlag',
            'Average Hauled Iron': 'Farmolt vas átlag',
        },
    },
    allowedMarkets: [],
...
(async function () {
    ...
    function buildUI() {
        ...
        twSDK.getAll(
            ...
            function (index, data) {
                ...
                const attackResults = jQuery(htmlDoc).find('#attack_results');
    ...
    function doFarmingCalculations(farmingData) {
        ...
        const avgHauledWood = parseInt(totalWoodHauled / farmingData.length);
        const avgHauledClay = parseInt(totalClayHauled / farmingData.length);
        const avgHauledIron = parseInt(totalIronHauled / farmingData.length);
