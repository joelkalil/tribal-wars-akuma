...
(async function () {
    ...
    function initSetVillageNote() {
        ...
        const defenderPlayerName = jQuery('table#attack_info_def')[0].rows[0]
            .cells[1].textContent;
        ...
        if (defenderPlayerName !== '---') {
            ...
            noteText += `[url="${reportLink}"]${twSDK.tt('Report Link')}[/url]`;
            ...
            UI.ErrorMessage(twSDK.tt('Note can not be added for this report!'));
        }
    }
