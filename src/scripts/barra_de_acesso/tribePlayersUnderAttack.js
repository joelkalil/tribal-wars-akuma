...
(async function () {
        ...
        if (playersToFetch.length) {
            ...
            twSDK.getAll(
                ...
                function (index, data) {
                    ...
                    totalIncs = parseInt(twSDK.sumOfArrayItemValues(totalIncs));
    ...
    function buildSinglePlayerIncomingsTable(incomings) {
        ...
        game_data.units.forEach((unit) => {
            if (unit !== 'militia') {
                troopsHead += `<th width="6.5%"><img src="/graphic/unit/unit_${unit}.webp"></th>`;
            }
        });
