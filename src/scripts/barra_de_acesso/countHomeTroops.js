...
var scriptConfig = {
    ...
    translations: {
        ...
        it_IT: {
            ...
            'There was an error!': 'There was an error!',
            'Premium Account is required for this script to run!':
                'É necessario un account premium per utilizzare questo script!',
            ...
            'Spears amount': 'Quantità Lancieri',
            'Swords amount': 'Quantità Spadaccini',
            'Archers amount': 'Quantità Arcieri',
            'Heavy cavalry amount': 'Quantità Cavalleria pesante',
        ...
        fr_FR: {
            ...
            'There was an error!': 'There was an error!',
            'Premium Account is required for this script to run!':
                "Un compte Premium est requis pour que ce script s'exécute!",
            'Offensive Troops': 'Troupes offensives',
            'Defensive Troops': 'Troupes défensives',
            'Export Troop Counts': 'Export Troop Counts',
...
(async function () {
    ...
    function getTroopsBBCode(totalTroopsAtHome) {
        ...
        bbCode += `[b]${twSDK.tt('Current Group:')}[/b] ${currentGroup}\n\n`;
